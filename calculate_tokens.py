#!/usr/bin/env python3
"""Calculate exact token counts from file contents"""

# Reading file contents and counting characters
files_content = {
    'SKILL.md': '''---
...
print("=" * 70)
print(f"\nUsing approximation: ~4 characters per token (cl100k_base encoding)\n")
...
for filename, content in files_content.items():
    ...
    total_chars += chars
    total_tokens += tokens
    print(f"{filename:50} {tokens:>6,} tokens ({chars:,} chars)")

print(f"\n{'TOTAL':50} {total_tokens:>6,} tokens ({total_chars:,} chars)")
print("=" * 70)
