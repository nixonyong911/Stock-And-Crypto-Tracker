...
const RAW_PATTERNS: ReadonlyArray<{ label: string; source: string; flags: string }> = [
  ...
  { label: "analysis_tool", source: "\\banalysis_get_(?:stock|statistics)\\b", flags: "i" },
  { label: "analysis_pattern", source: "\\banalysis_(?:list_patterns|get_bullish|get_bearish)\\b", flags: "i" },
