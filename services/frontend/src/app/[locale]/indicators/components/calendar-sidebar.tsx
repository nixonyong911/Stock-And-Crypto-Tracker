    ...
    return (
      <Card className="w-[280px] shrink-0 h-fit sticky top-4">
        ...
        <CardContent className="space-y-4">
          <ReleaseSection title="Today" releases={grouped.today} showDate={false} />
          <ReleaseSection title="Tomorrow" releases={grouped.tomorrow} showDate={false} />
          <ReleaseSection title="This Week" releases={grouped.thisWeek} />
          <ReleaseSection title="Next Week" releases={grouped.nextWeek} />
        ...
        <CollapsibleTrigger asChild>
          <Button variant="ghost" className="w-full justify-between p-4 h-auto">
            <div className="flex items-center gap-2">
              <Calendar className="h-4 w-4" />
              <span className="font-semibold">Upcoming Releases</span>
              {totalUpcoming > 0 && (
                <Badge variant="secondary" className="ml-2">
                  {totalUpcoming} this week
                </Badge>
              )}
            </div>
