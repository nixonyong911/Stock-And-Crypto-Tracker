...
namespace SimFin.Worker.Workers;

/// <summary>
/// Background worker that fetches SimFin fundamentals on a schedule.
...
public class FundamentalsFetchWorker : BackgroundService
{
    ...
    {
        _logger.LogInformation("Starting scheduled fundamentals fetch from SimFin");
