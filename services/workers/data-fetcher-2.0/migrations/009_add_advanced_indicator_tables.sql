...
-- These are separate from the basic indicator tables (analysis_indicators_stock_free / analysis_indicators_crypto_free)
-- to support tier-based access control at the data level.

CREATE TABLE IF NOT EXISTS analysis_indicators_stock_pro (
...
CREATE TABLE IF NOT EXISTS analysis_indicators_crypto_pro (
    id                  bigint GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
