...
All Docker containers (including gateway-2.0) have logs collected automatically via Docker's logging driver. View logs with:

```bash
docker logs <container-name> -f
docker logs gateway-2.0 --tail 100
```
