...
BACKEND_SERVICES="caddy n8n twelvedata fred-worker candlestick-analysis metrics alloy redis rabbitmq mcp-analysis telegram-bot-2.0 ai-hub2 back-office data-fetcher-2.0"
